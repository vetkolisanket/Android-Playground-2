...
import com.sanket.androidplayground2.databinding.ActivityParallelNetworkCallBinding
...
class ParallelNetworkCallActivity : AppCompatActivity() {
    ...
    private val binding by lazy { ActivityParallelNetworkCallBinding.inflate(layoutInflater) }
