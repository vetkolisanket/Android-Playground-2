...
import com.sanket.androidplayground2.databinding.ActivitySeriesNetworkCallBinding
...
class SeriesNetworkCallActivity : AppCompatActivity() {
    ...
    private val binding by lazy { ActivitySeriesNetworkCallBinding.inflate(layoutInflater) }
